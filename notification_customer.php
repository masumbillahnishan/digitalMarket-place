            ...
            <nav class="bg-slate-800  text-white subpixel-antialiased text-2xl w-fit h-18  flex w-screen fixed">
                <div class="flex-auto  mx-6">
                    <div class="flex">
                        ...
                        <a class="flex-auto my-6" href="notification_customer.php">
    ...
    <main class="flex mx-auto">
        ...
        <section class=" backdrop-opacity-60 backdrop-grayscale bg-white/60 p-8 rounded-lg shadow-md w-96 h-96 border border-2 border-cyan-300 mx-auto my-12">
            <div class="text-center">
                <h1 class="text-2xl font-semibold text-cyan-700 mb-4">customer Information</h1>
            </div>

            <div class="p-4">
                <div class="mb-4 flex">
                    <label class="block text-gray-700 font-semibold" for="customer-name">customer Name:</label>
                    <p class="text-gray-800 border border-2 border-cyan-500 px-4" id="customer-name"><?php echo $name; ?></p>
                </div>

                <div class="mb-4 flex">
                    <label class="block text-gray-700 font-semibold" for="customer-address">customer Address:</label>
                    <p class="text-gray-800  border border-2 border-cyan-500 px-4" id="customer-address"><?php echo $address; ?></p>
                </div>

                <div class="mb-4 flex">
                    <label class="block text-gray-700 font-semibold" for="customer-email">customer Email:</label>
                    <p class="text-gray-800  border border-2 border-cyan-500 px-4" id="customer-email"><?php echo $userEmail; ?></p>
                </div>
                <div class="flex">
                    <label class="block text-gray-700 font-semibold" for="customer-id">customer ID:</label>
...
if ($ck) {
    echo '<h1 class="text-4xl font-bold text-center mb-6">Notification</h1>';
